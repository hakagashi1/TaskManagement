<%-- 
    Document   : manageUser
    Created on : Nov 27, 2021, 10:17:57 AM
    Author     : ZenBook
--%>
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <c:forEach items="<%=projectAction%>" var="p">
                                        <li class="nav-item"> <a class="nav-link" href="../project/${p.name.toLowerCase()}-project">${p.name}</a></li>
                                        </c:forEach>
                                </ul>
                            </div>
                        </li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${listT}" var="t">
                                                        <tr>
                                                            ...
                                                            <td>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="${t.name}">
                                                            <button type="button" class="btn btn-sm btn-secondary">Members</button>
                                                            <i class="typcn typcn-chevron-right menu-arrow"></i>
                                                        </a>
                                                        <div class="collapse" id="ui-basic">
                                                            <ul class="nav flex-column sub-menu">
                                                                <c:forEach items="${t.members}" var="u">
                                                                    <li class="nav-item"> 
                                                                        <div class="row">
                                                                            <div class="col">
                                                                                <a class="nav-link" href="#">${u.firstname} ${u.lastname}</a>
                                                                            </div>
                                                                            <div class="col">
                                                                                <a href="../../manage-team?teamId=${t.id}&userId=${u.id}">
                                                            ...
                                                            <button type="button" class="btn btn-outline-secondary btn-rounded btn-icon" data-toggle="modal" data-target="#exampleModalLong${t.id}">
                                                                + 
                                                            </button>
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="exampleModalLong${t.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="../../manage-team?teamId=${t.id}" method="post">
                                                                            <div class="modal-body">
                                                                                <div class="form-group">
                                                                                    <label for="team-id" class="col-form-label">
                                                                                        Team ID:
                                                                                    </label>
                                                                                    <input type="text" class="form-control" id="product-name" name="team-id" value="${t.id}" disabled>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="member-id" class="col-form-label">
                                                                                        Member ID:
                                                                                    </label>
                                                                                    <input type="text" class="form-control" id="product-name" name="member-id">
                                                                                </div>
                                                                            </div>
                                            ...
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-outline-secondary btn-rounded btn-icon" data-toggle="modal" data-target="#exampleModalLong">
                                                +
                                            </button>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="../../add-team" method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="leader-id" class="col-form-label">
                                                                        Leader ID:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="product-name" name="leaderId">
                                                                </div>
                                                                <div class="form-group">
